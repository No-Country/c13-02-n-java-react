...
import proudctsServices from "./services/products.js";
...
function App() {
    ...
    useEffect(() => {
        if (storedToken) {
            proudctsServices.setToken(storedToken);
        }
            ...
            <BrowserRouter>
                <Routes>
                    {/* Rutas sin proteger  */}
                    {
                        ...
                        isdesktop ? <Route path="/" element={<Pages.Landing/>}/> :
                            <Route path="/" element={<LayoutOnboarding/>} children={[
